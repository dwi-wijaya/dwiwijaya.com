  ...
  return (
    <>
      ...
      <div className="about__container grid">
        <Image src={Freelance} alt="Freelance" className='about__img' />
        <div className="about__data">
          <Info />
          <p className='about_descriprion'>
            {`I'm Dwi Wijaya from Indonesia a seasoned Full Stack Developer with over 2 years of professional experience.
