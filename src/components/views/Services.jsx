    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-4">
        {ServicesData.map(({ id, icon, title, description }) => {
          return (
            <div data-aos="fade-right" className="card text-center !p7-6 hover:translate-y-3 ring-0 hover:ring-1 hover:ring-primary dark:hover:ring-1 dark:hover:ring-[#ff9f8c68]" key={id}>
