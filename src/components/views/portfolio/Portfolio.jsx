        ...
        {items.map((elem) => {
          ...
          return (
            <Link key={id} href={`portfolio/${slug}`}>
              <div data-aos="fade-right" className="group/portfolio relative flex flex-col overflow-hidden rounded-xl ">
                <div className="work__thumbnail">
                  ...
                  <div className="relative">
                    <Image src={thumbnail} alt="" width={999} height={999} className="w-full object-cover h-48" />
