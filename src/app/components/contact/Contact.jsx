      ...
      <div className="contact__container">
        <div className="contact-content">
          ...
          <div className="contact__info">
            ...
            <div style={{ backgroundColor: 'rgb(14 165 233)' }} className="contact__card">
